...
export default function ReportChatModal({ isOpen, onClose, tutorName, onSubmitReport, isMessageReport = false }: ReportChatModalProps) {
        ...
        <ModalBody>
          <p className="text-sm text-gray-600 mb-4">
            {isMessageReport ? (
              ...
              <>
                Estás reportando tu conversación completa con <strong>{tutorName}</strong>. 
                Esta acción será revisada por nuestro equipo de moderación.
              </>
            )}
          </p>
          ...
          <div className="bg-warning-50 border border-warning-200 rounded-lg p-3 mt-4">
            <p className="text-xs text-warning-800">
              <strong>Nota:</strong> Los reportes falsos pueden resultar en sanciones para tu cuenta.
            </p>
          </div>
        </ModalBody>
        <ModalFooter>
